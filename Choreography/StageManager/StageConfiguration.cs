...
namespace Choreography.StageManager
{
    internal sealed class StageConfiguration
    {
        ...
        // The following three belong to the Casting election protocol scaffold —
        // not consumed today. See Choreography/Transport/Messages/CastingMessages.cs
        // (top-of-file comment) for the protocol state and stage 2.
